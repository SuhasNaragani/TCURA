  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container px-6 py-16 max-w-6xl mx-auto">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed text-justify">
              <p className="text-base">
                TCura was founded with a simple yet powerful vision: to make world-class healthcare accessible and affordable to everyone, regardless of their location or financial situation.
              </p>
              <p className="text-base">
        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Why Choose TCura?</h2>
